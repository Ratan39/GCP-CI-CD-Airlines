...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-cicd")
    bq_project = Variable.get("bq_project", default_var="data-engineering-456818")
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="data-engineering-456818",
        region="us-central1",
